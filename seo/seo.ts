...
//
// SOURCE OF TRUTH: lidless-fleet-kit/seo/seo.ts (derived from escoffier-fleet-kit,
// retargeted for Lidless: the open-source security / netops / homelab tooling lab).
// This file is COPIED into lidless-site (src/lib/seo.ts) by bin/fleet-sync.sh. Do NOT
// edit the copy in the site repo: edit it here and re-run fleet-sync.
...
export const FLEET = {
  ...
  org: {
    ...
    sameAs: ['https://github.com/solomonneas'],
  },
  // Every OG card renders at this size.
  ogImage: { width: 2400, height: 1260, type: 'image/png' },
  // Dark-watch palette: terminal-dark ground, signal-green accent.
  themeColor: { dark: '#0a0a0c', light: '#22c55e' },
} as const;
